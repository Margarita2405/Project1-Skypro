...
### Файлы логов
- masks.log - файл логов к модулю src/masks.py
- utils.log - файл логов к модулю src/utils.py
- Уровень логирования: DEBUG
- Поведение: файл перезаписывается при каждом запуске приложения

### Настройка
Чтобы изменить поведение логирования (например, отключить перезапись), 
отредактируйте настройки в файле masks.py, utils.py
